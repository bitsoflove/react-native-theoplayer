...
theo_features_ios = `sh ./ios/custom/theofeatures.sh ios ./ios/custom/Frameworks/`
theo_features_tvos = `sh ./ios/custom/theofeatures.sh tvos ./ios/custom/Frameworks`
...
Pod::Spec.new do |s|
  ...
  s.ios.vendored_frameworks = 'ios/custom/Frameworks/THEOplayerSDK.xcframework'
  s.tvos.vendored_frameworks = 'ios/custom/Frameworks/THEOplayerSDK.xcframework'
